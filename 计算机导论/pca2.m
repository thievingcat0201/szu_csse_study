    ...
    projected_test_data = eigen_faces' * (test_data - mean_face);
        ...
        for each_test_face_index = 1:test_face_number
            ...
            for each_train_face_index = 1:k
                ...
                label_of_minimun_k_values(each_train_face_index,1) = floor((train_data(1,each_train_face_index) - 1) / 10) + 1;
            end
            ...
            for each_train_face_index = k+1:size(projected_train_data,2)
                ...
                if (distance < max_value)
                    ...
                    label_of_minimun_k_values(index_of_max_value,1) = floor((train_data(1,each_train_face_index) - 1) / 10) + 1;
                    [max_value, index_of_max_value] = max(minimun_k_values);
                end
            end
            ...
            real_label = floor((test_data(1,each_test_face_index) - 1) / 10)+1;
